              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-4">
                  {selectedClient?.phone && (
                    <a href={`https://wa.me/55${selectedClient.phone.replace(/\\D/g, '')}`} target="_blank" rel="noreferrer" className="size-16 rounded-full bg-[#25D366]/10 border border-[#25D366]/20 flex items-center justify-center text-[#25D366] hover:bg-[#25D366] hover:text-white transition-all shadow-xl group" title="Falar no WhatsApp">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="size-6 group-hover:scale-110 transition-transform">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 animate-in fade-in duration-500">
                  <div className="bg-bg-card/40 p-10 rounded-[32px] border border-white/5 space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <p className="text-[11px] text-slate-500 font-bold uppercase tracking-widest">Contato: <span className="text-white ml-2 italic font-black">{selectedClient.phone || 'Não Informado'}</span></p>
